<template>
	<div>
		...
		<div style="width: 70%; display: block; margin-left: auto; margin-right: auto; margin-bottom: 30px; box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1);">
			<el-table v-if="isInOrganization() && !isFetching()" :data="organizationTable" style="width: 100%;">
		...
		<el-row>
			<el-col :span="11" style="padding: 10px;">
					...
					<el-form v-if="isInOrganization() && !isFetching()" class="form-container" style="width: 90%; padding-top: 2px;" ref="form"
						...
						<el-table :data="foundUser" style="width: 100%">
			...
			<el-col :span="2">
				<div v-if="isInOrganization() && !isFetching()" class="grid-content">
